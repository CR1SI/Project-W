...
func Enter() -> void:
	if animation.current_animation == "idle_long_end_left" or animation.current_animation == "idle_long_end_right" or animation.current_animation == "idle_long_end_down" or animation.current_animation == "idle_long_end_up":
